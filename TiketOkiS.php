                    ...
                    <div class="grid-12">
                        <div class="krg">
                            <div style="margin: 0px 30px;">
                                <div class="gambar">
                                    <img src="assets/img/Narsumm-02.png" alt="">
                                </div>
                            </div>
                            <div style="margin: 0px 30px;">
                                <div>
                                    ...
                                    <div style="display: flex; margin: 11px 0px 20px 0px;">
                                        <a href="http://twitter.com/share?text=Im Sharing on Twitter&url=https://urplan.id/TiketOkiS.php">
                                        <div class="icn" style="margin: 0px 10px 0px 0px;">
                                            <img src="assets/img/Twitter.png" alt="">
                                        </div>
                                        </a>
                                        <a href="http://www.facebook.com/sharer.php?u=https://urplan.id/TiketOkiS.php" target="_blank">
                ...
                <div class="baris">
                    ...
                    <div class="grid-12" style="margin-bottom: 110px;">
                        ...
                        <div style="background-color: #ffffff; padding: 30px;">
                            <div>
                                INFO INI PENTING BANGET UNTUK KAMU YANG SUDAH MEMULAI BISNIS ATAU BELUM MEMPUNYAI BISNIS! <br><br>

                                Saya Oki Setiana Dewi, saya akan kasih tau kamu cara menjadi pengusaha hebat dan luar biasa! <br><br>
                                
                                Masa siii kamuu masih muda gitu kan, pasti dong ingin mempunyai bisnis, ya kan? <br><br>
                                ...
                                <div style=" display: flex;">
                                    ...
                                    <div style="margin-left:20px;">
                                        Kamu pastinya akan mendapat insight bahwa islam mengajarkan menjadi pengusaha sejak dini
                                    </div>
                                </div>
                                <div style=" display: flex;">
                                    <div><img src="assets/img/dua.png" alt=""></div>
                                    <div style="margin-left:20px;">
                                        Kamu akan mendapatkan trik cerdas bahwa kamu menjadi pengusaha 
                                    </div>
                                </div>
                                <div style=" display: flex;">
