...
if(isset($_POST['email_data']))
{
 ...
 foreach($_POST['email_data'] as $row)
 {
  ...
  $mail->Subject = 'Tautan Mengikuti Webinar bersama Syakir Daulay'; //Sets the Subject of the message
  //An HTML or plain text message body
  $mail->Body = '
  <p>Halooo</p>
  <p>Terima kasih sudah mendaftar dalam program Webinar Exclusive Impact bersama Syakir Daulay, mohon segera masuk ke grup whatsapp berikut ini untuk mendapatkan informasi lebih lanjut.</p>
