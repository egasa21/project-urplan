            ...
            <div class="wadah">
                <div class="baris">
                    <div class="grid-12">
                        ...
                        color: #16056B;
                        opacity: 0.5;">
                            Bagaimana Cara Membayar melalui Dana?
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div style="background-color: #ffffff;">
                            <div style="margin: 20px 0px 0px 15px;display: block">
                                <div class="grid-12" style="padding: 20px;">
                                    Cara mentransfer uang melalui DANA <br><br>
                                    ...
                                    <div style=" display: flex;">
                                        ...
                                        <div style="margin-left:20px;">
                                            Pilih Kirim di bagian atas atau masuk ke menu Transfer to Bank.
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                    ...
                                    <div style=" display: flex;">
                                        ...
                                        <div style="margin-left:20px;">
                                            Selanjutnya mengisi informasi bank:Nama Bank: Ketik nama bank yang kamu gunakan (misal: Mandiri).
                                            Nomor Akun: Isi dengan nomor rekening. Alias: Isi dengan nama rekening yang ingin disimpan (misal: Mandiriku, Mandiri Pacar, dll) 
                                            yaitu ke no rekening ini Bank BNI (kode bank 009) No.Rek 0899111480 A.n Abdul Rozzak Junaidi
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                        <div><img src="assets/img/lima.png" alt=""></div>
                                        <div style="margin-left:20px;">
                                            Kemudian klik Tambah Bank Baru.
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                        <div><img src="assets/img/enam.png" alt=""></div>
                                        <div style="margin-left:20px;">
                                            Berikutnya isi nominal transfer minimal Rp 10.000 (dikenakan biaya transfer), minimal Rp 50.000 (gratis biaya transfer), lalu klik Lanjut.
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                        <div><img src="assets/img/tujuh.png" alt=""></div>
                                        <div style="margin-left:20px;">
                                            Selanjutnya pilih sumber dana, klik Ganti jika ingin memilih sumber dana seperti dari kartu debit/kredit yang sudah tersimpan di DANA.
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                        <div><img src="assets/img/delapan.png" alt=""></div>
                                        <div style="margin-left:20px;">
                                            Berikutnya klik KIRIM DANA, kemudian periksa kembali detail transfer lalu klik Konfirmasi.
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                        <div><img src="assets/img/sembilan.png" alt=""></div>
                                        <div style="margin-left:20px;">
                                            Terakhir, masukkan PIN DANA.
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
