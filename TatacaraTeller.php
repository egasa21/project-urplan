            ...
            <div class="wadah">
                <div class="baris">
                    <div class="grid-12">
                        ...
                        color: #16056B;
                        opacity: 0.5;">
                            Bagaimana Cara Membayar melalui Teller Bank?
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div style="background-color: #ffffff;">
                            <div style="margin: 20px 0px 0px 15px;display: block">
                                <div class="grid-12" style="padding: 20px;">
                                    Cara mentransfer uang melalui Teller Bank <br> <br>
                                    <div style=" display: flex;">
                                        <div><img src="assets/img/satu.png" alt=""></div>
                                        <div style="margin-left:20px;">
                                            Yang pertama, anda bisa datang ke bank yang anda tuju 
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                        ...
                                        nomor antrian oleh teller. Dan jangan lupa untuk mengambil dulu slip transferannya. 
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                        <div><img src="assets/img/tiga.png" alt=""></div>
                                        <div style="margin-left:20px;">
                                            Lalu ambil slip/formulir untuk SETOR TUNAI warna biru.
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                        ...
                                        <div style="margin-left:20px;">
                                            ...
                                            transfer dan isikan nominal uang yang ingin anda transfer,yaitu ke no rekening ini 
                                            Bank BNI (kode bank 009) 
                                            No.Rek 0899111480 
                                            A.n Abdul Rozzak Junaidi.
                                            lalu isikan data diri anda dalam formulir tersebut.Dengan BENAR
                                        </div>
                                    </div>                  
                                </div>
                            </div>
