...
if(isset($_POST['email_data']))
{
 ...
 foreach($_POST['email_data'] as $row)
 {
  ...
  $mail->Subject = 'Tautan Mengikuti Webinar bersama Oki Setiana Dewi'; //Sets the Subject of the message
  //An HTML or plain text message body
  $mail->Body = '
  <p>Halooo</p>
  <p>Terima kasih sudah mendaftar dalam program Webinar Exclusive Impact bersama Oki Setiana Dewi, mohon segera masuk ke grup whatsapp berikut ini untuk mendapatkan informasi lebih lanjut.</p>
