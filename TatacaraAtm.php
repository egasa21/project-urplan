                        ...
                        <div style="background-color: #ffffff;">
                            <div style="margin: 20px 0px 0px 15px;display: block">
                                <div class="grid-12" style="padding: 20px;">
                                    Cara mentransfer uang melalui ATM  <br>                                    
                                    <div style=" display: flex;">
                                        <div><img src="assets/img/satu.png" alt=""></div>
                                        <div style="margin-left:20px;">
                                            Yang pertama, sesuaikan ATM dengan bank tempat anda menabung. 
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                    ...
                                    <div style=" display: flex;">
                                        ...
                                        <div style="margin-left:20px;">
                                            Pilih Bahasa yang ingin anda gunakan : Pilih bahasa Indonesia. 
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                        ...
                                        ATM sangatlah rahasia, maka jangan memberikan PIN ATM anda kepada orang lain. 
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                    ...
                                    <div style=" display: flex;">
                                        ...
                                        ketik kembali kode bank dan nomor rekening tujuan anda yaitu ke no rekening ini 
                                        Bank BNI (kode bank 009) No.Rek 0899111480 A.n Abdul Rozzak Junaidi. Setelah itu, pilih “BENAR”. 
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                    ...
                                    <div style=" display: flex;">
                                        ...
                                        data hingga benar semua. Jika sudah, pilih “YA” jika semua data sudah sesuai. 
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
