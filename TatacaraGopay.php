            ...
            <div class="wadah">
                <div class="baris">
                    <div class="grid-12">
                        ...
                        color: #16056B;
                        opacity: 0.5;">
                            Bagaimana Cara Membayar melalui Gopay?
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="grid-12">
                        <div style="background-color: #ffffff;">
                            <div style="margin: 20px 0px 0px 15px;display: block">
                                </div><div class="grid-12" style="padding: 20px;">
                                    Cara mentransfer uang melalui Go-Pay <br><br>
                                    Pastikan kamu dan orang yang akan akan kamu kirimkan uang sudah mempunyai <br>
                                    ...
                                    <div style=" display: flex;">
                                        ...
                                        <div style="margin-left:20px;">
                                            Pilih Transfer instan ke rek.baru.
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                    ...
                                    <div style=" display: flex;">
                                        ...
                                        <div style="margin-left:20px;">
                                            Pilih nama pemilik rekening yaitu ke no rekening ini Bank BNI (kode bank 009) No.Rek 0899111480 A.n Abdul Rozzak Junaidi dan klik Lanjut.
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                    ...
                                    <div style=" display: flex;">
                                        ...
                                        <div style="margin-left:20px;">
                                            Klik Konfirmasiuntuk melanjutkan dan masukkan PIN kamu.
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                        <div><img src="assets/img/sepuluh.png" alt=""></div>
                                        <div style="margin-left:20px;">
                                            Yeay! Transfer atau pengiriman saldo ke rekening bank berhasil.  
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                        <div><img src="assets/img/sebelas.png" alt=""></div>
                                        <div style="margin-left:20px;">
                                            Kamu akan melihat rincian transfer. 
                                        </div>
                                    </div>
                                </div>
                            </div>
