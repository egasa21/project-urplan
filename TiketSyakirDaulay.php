                    ...
                    <div class="grid-12">
                        <div class="krg">
                            <div style="margin: 0px 30px;">
                                <div class="gambar">
                                    <img src="assets/img/Narsumm-01.png" alt="">
                                </div>
                            </div>
                            <div style="margin: 0px 30px;">
                                <div>
                                    ...
                                    <div style="display: flex; margin: 11px 0px 20px 0px;">
                                        <a href="http://twitter.com/share?text=Im Sharing on Twitter&url=https://urplan.id/TiketSyakirDaulay.php">
                                        <div class="icn" style="margin: 0px 10px 0px 0px;">
                                            <img src="assets/img/Twitter.png" alt="">
                                        </div>
                                        </a>
                                        <a href="http://www.facebook.com/sharer.php?u=https://urplan.id/TiketSyakirDaulay.php" target="_blank">
                ...
                <div class="baris">
                    ...
                    <div class="grid-12" style="margin-bottom: 110px;">
                        ...
                        <div style="background-color: #ffffff; padding: 30px;">
                            <div>
                                MUDA KOK BUCIN MULU! UDAH ADA PENDAPATAN SENDIRI BARU BUCIN! JANGAN PAKE DUIT ORANG TUA BUAT BUCIN! <br><br>

                                Eiuts, ikan hiu makan tomat... Ehhh skak mat! <br><br>
                                
                                Gue Syakir Daulay, gue akan kasih tau lu cara memulai dan menjalani bisnis untuk pemula! <br><br>
                                
                                Masa siii lu masih muda gitu kan, pasti dong ingin mempunyai bisnis, ya kan? <br><br>
                                
                                Pasti dong ingin membantu orang tua dengan mempunyai pendapatan sendiri, ya kannn???! <br><br>
                                
                                Udahhh nih yeee, ikutin webinar bareng gue! Exclusive banget, cuman 100 orang aja! Ga bakal rugi deh ikut webinar bareng gue. <br><br>
                                
                                Kenapa harus ikut webinar bareng gue? 
                                <div style=" display: flex;">
                                    <div><img src="assets/img/satu.png" alt=""></div>
                                    <div style="margin-left:20px;">
                                        Lu bisa tau nih cara memulai bisnis
                                    </div>
                                </div><div style=" display: flex;">
                                    <div><img src="assets/img/dua.png" alt=""></div>
                                    <div style="margin-left:20px;">
                                        Lu berpeluang nih dapet buku karya gue, btw gue udah siapin 10 buku!
                                    </div>
                                </div><div style=" display: flex;">
                                    <div><img src="assets/img/tiga.png" alt=""></div>
                                    <div style="margin-left:20px;">
                                        Lu juga bisa dapet doorprize yang udah gue siapin nih ada 5 produk Hijab Kobul dan 5 produk Real Kashmira
                                    </div>
                                </div><div style=" display: flex;">
                                    <div><img src="assets/img/empat.png" alt=""></div>
                                    <div style="margin-left:20px;">
                                        Lu bisa menginfakkan tenaga, fikiran, serta harta lu di jalan Allah
                                    </div>
                                </div><div style=" display: flex;">
                                    <div><img src="assets/img/lima.png" alt=""></div>
                                    <div style="margin-left:20px;">
                                        Lu bisa dapet akses GRATIS! Mentoring Bisnis bersama Founder UR Plan secara intens untuk mengembangkan bisnis lu hingga 12 bulan, modul modul mentoring bisa dilihat dibawah ini!
                                    </div>
                                </div>
                                <br><br>
                                ...
                                Gila kan??? Udah jangan kebanyakan mikir, langsung action! <br> <br>
