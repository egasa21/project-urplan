 ...
 <body>
  ...
  <div class="container">
   ...
   <div class="table-responsive">
       <a href="minimalis_view.php">Minimalis View</a>
    <table class="table table-bordered table-striped" style="max-height: 400;">
    <tr>
        <th>No</th>
        <th>Email</th>
        <th>Nama</th> 
    ...
    <?php
   include 'config.php';
   $query = mysqli_query($db, "SELECT * FROM pendaftar3");
   $nomor = 1;
    ...
    <br> <a href="export3.php">Export to excel</a>
   </div>
  </div>
 </body>
</html>
