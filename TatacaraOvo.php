            ...
            <div class="wadah">
                <div class="baris">
                    <div class="grid-12">
                        ...
                        color: #16056B;
                        opacity: 0.5;">
                            Bagaimana Cara Membayar melalui OVO?
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div style="background-color: #ffffff;">
                            <div style="margin: 20px 0px 0px 15px;display: block">
                                <div class="grid-12" style="padding: 20px;">
                                    Cara mentransfer uang melalui OVO <br><br>
                                    <div style=" display: flex;">
                                        <div><img src="assets/img/satu.png" alt=""></div>
                                        <div style="margin-left:20px;">
                                            Masuk ke menu ‘Transfer’ pada laman Home OVO.
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                        <div><img src="assets/img/dua.png" alt=""></div>
                                        <div style="margin-left:20px;">
                                            Pilih ‘Ke 'Rekening Bank'. Pilih ‘Bank Tujuan’
                                            Anda melakukan transfer Masukkan nomor rekening
                                            tujuan dan nominal transfer (Min. Rp10.000,-)
                                            yaitu ke no rekening ini
                                    ...
                                    <div style=" display: flex;">
                                        ...
                                        <div style="margin-left:20px;">
                                            Klik ‘Lanjutkan’ untuk melanjutkan transfer. Akan 
                                            muncul halaman konfirmasi transfer yang berisi detail 
                                            penerima transfer dan nominal transfer. Pastikan kembali 
                                            data-data yang telah Anda masukkan.
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                        <div><img src="assets/img/empat.png" alt=""></div>
                                        <div style="margin-left:20px;">
                                            Jika sudah benar, klik ‘Transfer’ untuk melanjutkan.
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
