            ...
            <div class="wadah">
                <div class="baris">
                    <div class="grid-12">
                        ...
                        color: #16056B;
                        opacity: 0.5;">
                            Bagaimana Cara Membayar melalui Alfamart?
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div style="background-color: #ffffff;">
                            <div style="margin: 20px 0px 0px 15px;display: block">
                                <div class="grid-12" style="padding: 20px;">
                                    Cara mentransfer uang melalui Alfamart <br> <br>
                                    ...
                                    <div style=" display: flex;">
                                        ...
                                        <div style="margin-left:20px;">
                                            ...
                                            ingin melakukan pengiriman uang 
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                        ...
                                        <div style="margin-left:20px;">
                                            ...
                                            yang masih berlaku dan nomor telepon aktif  
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                        <div><img src="assets/img/tiga.png" alt=""></div>
                                        <div style="margin-left:20px;">
                                             Selanjutnya kirim ke no rekening ini Bank BNI (kode bank 009) No.Rek 0899111480 A.n Abdul Rozzak Junaidi  
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                        ...
                                        <div style="margin-left:20px;">
                                            ...
                                            beserta biaya administrasi yang dibebankan 
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                    ...
                                    <div style=" display: flex;">
                                        ...
                                        <div style="margin-left:20px;">
                                            ...
                                            bukan penerima yang seharusnya 
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                        <div><img src="assets/img/tujuh.png" alt=""></div>
                                        <div style="margin-left:20px;">
                                             Kode MTCN merupakan kode khusus keamanan mengirim uang lewat Alfamart. 
                                        </div>
                                    </div>
                                </div>
                            </div>
