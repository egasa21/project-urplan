            ...
            <div class="wadah">
                <div class="baris">
                    <div class="grid-12">
                        ...
                        color: #16056B;
                        opacity: 0.5;">
                            Bagaimana Cara Membayar melalui LinkAja?
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div style="background-color: #ffffff;">
                            <div style="margin: 20px 0px 0px 15px;display: block">
                                <div class="grid-12" style="padding: 20px;">
                                    Cara mentransfer uang melalui LinkAja <br><br>
                                    Yang pertama, pastikan kamu sudah mempunyai aplikasi LinkAja <br>
                                    <div style=" display: flex;">
                                        <div><img src="assets/img/satu.png" alt=""></div>
                                        <div style="margin-left:20px;">
                                            Buka aplikasi LinkAja di ponsel kamu, lalu pilih menu Kirim Uang.
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                        <div><img src="assets/img/dua.png" alt=""></div>
                                        <div style="margin-left:20px;">
                                            Selanjutnya pilih Tab Bank, kemudian pilih nama bank tujuan transfer
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                        <div><img src="assets/img/tiga.png" alt=""></div>
                                        <div style="margin-left:20px;">
                                            Setelah itu masukan nomor rekening bank yaitu ke no rekening ini Bank BNI (kode bank 009) No.Rek 0899111480 A.n Abdul Rozzak Junaidi tujuan transfer lalu tap tombol Lanjut.
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                        <div><img src="assets/img/empat.png" alt=""></div>
                                        <div style="margin-left:20px;">
                                            Masukan nominal uang yang akan dikirim kemudian tap tombol Ceklis.
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                        ...
                                        <div style="margin-left:20px;">
                                            ...
                                            dan BTN jadi tidak gratis berbeda dengan saat kita mengisi saldo. 
                                        </div>
                                    </div>
                                    <div style=" display: flex;">
                                        ...
                                        <div style="margin-left:20px;">
                                            ...
                                            menerima sms notifikasi dari linkaja ke nomor yang terdaftar 
                                        </div>
                                    </div>
                                </div>
                            </div>
